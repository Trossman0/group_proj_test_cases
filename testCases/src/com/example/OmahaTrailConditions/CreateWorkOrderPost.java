...
public class CreateWorkOrderPost {
  ...
  @Test
  public void testCreateWorkOrderPost() throws Exception {
    ...
    new Select(driver.findElement(By.name("PostType"))).selectByVisibleText("Work Request");
    driver.findElement(By.xpath("//input[@value='Select Post Type']")).click();
    driver.get("http://ec2-3-21-185-132.us-east-2.compute.amazonaws.com:8080/csci4830-project1/post_work.html");
    ...
    new Select(driver.findElement(By.name("TrailName"))).selectByVisibleText("Tranquility");
