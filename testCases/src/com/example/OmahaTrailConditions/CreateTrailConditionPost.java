...
public class CreateTrailConditionPost {
  ...
  @Test
  public void testCreateTrailConditionPost() throws Exception {
    ...
    new Select(driver.findElement(By.name("PostType"))).selectByVisibleText("Trail Condition Update");
    driver.findElement(By.xpath("//input[@value='Select Post Type']")).click();
    driver.get("http://ec2-3-21-185-132.us-east-2.compute.amazonaws.com:8080/csci4830-project1/post_condition.html");
    ...
    new Select(driver.findElement(By.name("TrailName"))).selectByVisibleText("Other");
    driver.findElement(By.xpath("//form[@action='InsertDB']")).click();
    driver.findElement(By.name("Score")).click();
    new Select(driver.findElement(By.name("Score"))).selectByVisibleText("3 - Damp");
